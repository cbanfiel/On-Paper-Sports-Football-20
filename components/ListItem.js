...
export default class ListItem extends React.Component {
    ...
    render() {
        return(
            ...
            <View style={{ backgroundColor: this.props.color? this.props.color : 'rgba(255,255,255,0)', flexDirection:'row', paddingVertical:10, alignItems:"center", height:this.props.xl?100:70, overflow:"hidden", borderBottomWidth:.5 }}>
